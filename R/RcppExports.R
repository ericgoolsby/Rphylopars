...
C_anc_recon <- function(Y, anc, des, edge_vec, nedge, nvar, nspecies) {
    .Call('Rphylopars_C_anc_recon', PACKAGE = 'Rphylopars', Y, anc, des, edge_vec, nedge, nvar, nspecies)
}

C_anc_recon_rates <- function(Y, anc, des, edge_vec, nedge, nvar, nspecies, REML) {
    .Call('Rphylopars_C_anc_recon_rates', PACKAGE = 'Rphylopars', Y, anc, des, edge_vec, nedge, nvar, nspecies, REML)
}
